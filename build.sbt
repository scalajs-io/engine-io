...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/engine.io</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/engine.io.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/engine.io.git</developerConnection>
        <url>github.com/scalajs-io/engine.io.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
